...
v('73 fiches au départ', 73, await page.evaluate(() =>
...
v('potimarron trouve des fiches', true, r.fiches > 0 && r.fiches < 73);
...
v('tout revient en vidant', 73, remis.fiches);
v('index revenus', 3, remis.index);
v('sommaire revenu', 73, remis.toc);
